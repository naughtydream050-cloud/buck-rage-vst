...
- GitHub Actions run `25779225758` passed.
- Downloaded artifact to `reports/latest/rude-hype/rude-hype-vst3-windows.zip`.
...
- The current PR uses runtime image fallback for CI/text-only build. Distribution builds should embed the faceplate and knob images.
