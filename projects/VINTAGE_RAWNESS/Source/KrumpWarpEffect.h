...
private:
    ...
    static constexpr float kBaseDelayMs = 5.5f;
    static constexpr float kDelaySmooth = 0.080f;
    ...
    static constexpr float kFlangeMinHz = 0.18f;
    static constexpr float kFlangeMaxHz = 1.15f;
    static constexpr float kFlutterMinHz = 4.0f;
    static constexpr float kFlutterMaxHz = 11.0f;
    static constexpr float kJitterMinMs = 0.15f;
    static constexpr float kJitterMaxMs = 1.15f;
    ...
    float flangePhase[kMaxChannels] { 0.0f, 0.0f };
    float flangeFeedback[kMaxChannels] { 0.0f, 0.0f };
    float flutterNoise[kMaxChannels] { 0.0f, 0.0f };
    float slopNoise[kMaxChannels] { 0.0f, 0.0f };
    float heldSample[kMaxChannels] { 0.0f, 0.0f };
    float crushedState[kMaxChannels] { 0.0f, 0.0f };
